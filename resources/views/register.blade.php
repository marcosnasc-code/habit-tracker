    ...
    <main class="flex min-h-screen items-center justify-center p-6">
        <section class="flex w-full max-w-md flex-col gap-6 rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <header class="flex flex-col gap-2">
                ...
                <h1 class="text-2xl font-semibold tracking-tight">Cadastro de usuário</h1>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">Crie sua conta para acessar o sistema.</p>
            </header>
            ...
            <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-4" novalidate>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input
                        ...
                        autofocus
                        autocomplete="name"
                        class="rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 outline-none ring-emerald-500/40 placeholder:text-zinc-400 focus:border-emerald-500 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
                    >
                    @error('name')
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input
                        ...
                        class="rounded-lg border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 outline-none ring-emerald-500/40 placeholder:text-zinc-400 focus:border-emerald-500 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100 dark:placeholder:text-zinc-500 @error('email') border-red-500 dark:border-red-400 @enderror"
                    >
                    @error('email')
                        <p class="text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div class="flex flex-col gap-1.5">
                    <label for="password_confirmation" class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Confirmar senha</label>
                    <input
            ...
            <p class="text-center text-sm text-zinc-500 dark:text-zinc-400">
                Já tem conta?
                <a href="{{ route('login') }}" class="font-medium text-zinc-900 underline-offset-2 hover:underline dark:text-zinc-100">
                    Fazer login
                </a>
            </p>
        </section>
